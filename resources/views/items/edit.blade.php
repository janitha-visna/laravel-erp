...
@section('content')
    ...
    <div class="card shadow-sm border-0 mx-auto" style="max-width: 760px;">
        <div class="card-header bg-white py-3 d-flex align-items-center justify-content-between">
            <h5 class="mb-0 fw-bold">Edit <span class="text-info">Item</span></h5>
            ...
            <form method="POST" action="{{ route('items.update', $item) }}" novalidate>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        {{-- Preserve the current/old sub_category_id for AJAX pre-selection --}}
                        <input type="hidden" id="pre_sub"
...
<script>
    ...
    // Auto-load sub-categories for the current category on page load
    if (catSelect.value) {
        loadSubCategories(catSelect.value, preSub);
    }

    // Reload when user picks a different category
